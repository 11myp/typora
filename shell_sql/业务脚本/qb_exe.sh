...
#-------------------------------------------------------------------------
#使用：
#if [ "$busi_type" = "ALL" ]; then
#   /app/mcb/incs/bin/qb_exe.sh qb_sttl_voice_daily $start_dt $prov_cd
#   /app/mcb/incs/bin/qb_exe.sh qb_sttl_sms_daily $start_dt $prov_cd
#   /app/mcb/incs/bin/qb_exe.sh qb_sttl_rmm_daily $start_dt $prov_cd
#elif [ "$busi_type" = "VOICE" ]; then
#  /app/mcb/incs/bin/qb_exe.sh qb_sttl_voice_daily $start_dt $prov_cd
#elif [ "$busi_type" = "SMS" ]; then
#   /app/mcb/incs/bin/qb_exe.sh qb_sttl_sms_daily $start_dt $prov_cd
#elif [ "$busi_type" = "RMM" ]; then
#   /app/mcb/incs/bin/qb_exe.sh qb_sttl_rmm_daily $start_dt $prov_cd
#else
# NAME
# alias_qb.sh
